...
class Settings(BaseSettings):
    ...
    a SQLite file; on Cloud Run it's the Cloud SQL (Postgres) connection string.
    The code that reads it is identical.
    """
    ...
    # Explicit browser origins allowed to call the API. Not needed when the
    # frontend is served same-origin via Firebase Hosting → Cloud Run; set only
    # if the frontend lives on a different origin.
